...
export const appNavTabBase =
  "inline-flex items-center justify-center gap-1.5 rounded-full px-3 py-1.5 text-sm transition-colors sm:px-4 sm:py-2";
...
export const appNavUtilityButtonClass =
  "inline-flex items-center justify-center gap-1.5 rounded-full px-2.5 py-1.5 text-sm text-muted-foreground transition-colors hover:bg-muted/60 hover:text-foreground sm:px-3";
